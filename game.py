...
print('---- FINAL SCORE ----')
print('{}:\t{:.2f}'.format(sys.argv[1], m.p1_money))
print('{}:\t{:.2f}'.format(sys.argv[2], m.p2_money))
print('')

winner = sys.argv[1]
if m.p1_money > m.p2_money:
    print('WINNER: {}'.format(sys.argv[1]))
elif m.p1_money < m.p2_money:
    print('WINNER: {}'.format(sys.argv[2]))
else:
    print('TIED!')
...
with open('game_log.js', 'w') as f:
    f.write("window.game = {}".format(json_str))
